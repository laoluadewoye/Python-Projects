'''
    ...
    Next, i'm going to have each block set it's own parity check.
...
#second, list them in a array of their own
...
for i in range (dataBankLength):
    ...
    print("The bit", redundantBlocks[blockTick][index], "in index", index, "of block", blockTick, "is inserted into index", i, "of the storage.")
    time.sleep(0.05)
    blockTick += 1
    if (blockTick == 8):
        index += 1
